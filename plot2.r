...
#we  have done the work for in factoring as time stamp in above code only 

plot(powerRelevant$timestamp,powerRelevant$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
